<?php
	...
	$sql_pro = "SELECT * FROM giaovien WHERE ten_gv LIKE '%".$tukhoa."%'" ;
                ...
                <div class="pb-4 row nguyenphudien" style="margin-left: 20px;">
					...
					?>
                        <div class="col-lg-3 mb-4 " style="text-align: center;">
                            ...
                            <span>
                                <img style="width:300px; height:250px;"class="img-fluid" src="admin/images/<?php echo $row["anhdaidien"]; ?>"  alt="">
                            </span>
                            <a class="blog-overlay text-decoration-none" style="justify-content: center;" href="thongtingiaovien.php?id_giaovien=<?php echo $row["id_giaovien"]; ?>">
                                    <h5 class="text-white mb-3"style="width:100%;"><?php echo ucwords($row["ten_gv"]); ?></h5>    
                            </a>
                            </div>
