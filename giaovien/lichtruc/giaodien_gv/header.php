<?php include("config.php");
    ...
    if($row2 >0){
        $i='<li class="nav-item">
        <a class="nav-item nav-link" style="font-weight:bold;" href="sualichdemo.php">Xếp lịch trực</a>
    </li>';
    ...
    if($row3 > 0){
        $ii='<li class="nav-item">
            <a href="xepphong.php" class="nav-item nav-link" style="font-weight:bold;">Xếp phòng học</a>
    </li>';
    }else{
        $ii="";
    }
