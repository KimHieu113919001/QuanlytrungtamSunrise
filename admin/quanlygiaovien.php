 ...
 <div class="span9">
					<div class="content">
						<div class="module">
							...
							<a class="btn btn-success" href="../admin/themgiaovien.php">Thêm giáo viên</a> &ensp;
							</div> -->
							<div class="module-body table">
								...
								<thead style="font-weight:bold; text-align:center;">
										<tr>
											...
											<td style="text-align:center;">Tên giáo viên</td>
                    				...
                    				<?php 
                        				...
                        				<tr class="odd gradeX td">
											...
											<a class="btn btn-primary" href="../admin/thongtingiaovien.php?id_giaovien=<?php echo $row["id_giaovien"]; ?>">Thông tin</a>&ensp;
											<a class="btn btn-info" href="../admin/lopdangday.php?id_giaovien=<?php echo $row["id_giaovien"]; ?>">Lớp đang dạy</a>&ensp;
										</td>
