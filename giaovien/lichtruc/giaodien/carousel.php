        ...
        <div id="header-carousel" class="carousel slide carousel-fade" style="text-align:center;" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img  src="../../../sunrise/admin/images/<?php echo $row41["hinh"]; ?>" style="width: 74%; height:50%;">
                </div>
                <div class="carousel-item" >
                    <img  src="../../../sunrise/admin/images/<?php echo $row42["hinh"]; ?>" style="width: 74%; height:50%;">
                </div>
                <div class="carousel-item" >
                    <img  src="../../../sunrise/admin/images/<?php echo $row43["hinh"]; ?>" style="width: 74%; height:50%;">
                </div>
            </div>
        </div>
    </div>
