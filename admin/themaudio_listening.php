<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $res=false;
        $insert_query="INSERT INTO `cau_hoi_listening`(`id`, `noidung`,`hinhanh`,`id_de`,`trangthai`) VALUES ('','$noidung','$hinhanh','$id_de','$trangthai')";
...
<?php
 ...
 <div class="span9">
                    ...
                    <div class="control-group">
                      ...
                      <div class="control-group">
							<label class="control-label" for="basicinput">Chọn file</label>
							<div class="controls">
								<input data-title="A tooltip for the input" type="file" name="noidung" required data-original-title="" class="span8 tip">
							</div>
					    </div>
