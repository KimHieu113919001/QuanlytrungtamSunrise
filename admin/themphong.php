<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $insert_query="INSERT INTO `phong`(`id_phong`, `ten_phong`) VALUES ('','$ten_phong')";
              ...
              <?php echo $msg;?>
                <form action="" method="post" enctype="multipart/form-data"  >
                    <div class="control-group">
						...
						<div class="controls">
							<input data-title="A tooltip for the input" type="text" name="ten_phong" placeholder="Nhập tên phòng" required data-original-title="" class="span8 tip">
						</div>
					</div>
