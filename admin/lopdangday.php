<?php
   include("config.php");
    ...
    $sql= "SELECT * FROM danhsachlop, capbac WHERE danhsachlop.id_cap=capbac.id_cap AND danhsachlop.tt_hoatdong='0' AND danhsachlop.id_giaovien='$_GET[id_giaovien]' ORDER BY id_danhsach"; 
							...
							<div class="module-body table">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
                                    <thead>
                                        ...
                                        <!-- <td style="text-align:center;">Ngày học</td>
