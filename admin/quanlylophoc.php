        ...
        <div class="span9">
					<div class="content">
						<div class="module">
							...
							<a class="btn btn-success" href="../admin/themlophoc.php">Thêm cấp bậc</a> &ensp;
							</div>
							<div class="module-body table">
								...
								<thead style="font-weight:bold;">
										<tr>
											...
											<td style="text-align:center;">Cấp bậc thuộc khóa học</td>
                                    ...
                                    <?php if(mysqli_num_rows($res)>0){ ?>
                        				...
                        				<tr class="odd gradeX">
                                           ...
                                           <td style="text-align:center;"> <a class="btn btn-info" href="../admin/loptrongkhoa.php?id_khoahoc=<?php echo $row["id_khoahoc"]; ?>">Chọn</a></td>&ensp;
										</tr>
                        <?php } }?>
									</tbody>
