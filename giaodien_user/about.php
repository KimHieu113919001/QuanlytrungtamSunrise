                ...
                <div class="col-lg-7">
                    ...
                    <?php 
                        ...
                        if(mysqli_num_rows($res_tb)>0){ ?>
                            ...
                            <div><i class="fas fa-angle-double-right"></i>&ensp;<a style="font-size: 20px; color:#000000;" href="user_thongbao.php?id_thongbao=<?php echo $row_tb['id_thongbao']?>"><?php echo $row_tb['tieude']?></a></div>
                            <?php } 
                        }else{
