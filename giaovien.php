...
<!-- Search Form -->
<div class="mb-2 ">
    <form action="timkiemgiaovien.php" method="POST">
            ...
            <h5 class=" text-uppercase mb-3" style="letter-spacing: 5px; color:black;">Giáo viên ngoại ngữ</h5>
                <div class="pb-3 row nguyenphudien">
                    ...
                    <div class="col-lg-3 mb-4 " style="text-align: center;">
                            ...
                            <a class="blog-overlay text-decoration-none" style="justify-content: center;" href="thongtingiaovien.php?id_giaovien=<?php echo $row_nn["id_giaovien"]; ?>">
            ...
            <h5 class=" text-uppercase mb-3" style="letter-spacing: 5px;color:black;">Giáo viên Tin học</h5>
                <div class="pb-3 row nguyenphudien">
                    ...
                    <div class="col-lg-3 mb-4 " style="text-align: center;">
                            ...
                            <a class="blog-overlay text-decoration-none" style="justify-content: center;" href="thongtingiaovien.php?id_giaovien=<?php echo $row_th["id_giaovien"]; ?>">
            ...
            <h5 class=" text-uppercase mb-3" style="letter-spacing: 5px; color:black;">Giáo viên khác</h5>
                <div class="pb-3 row nguyenphudien">
                    ...
                    <div class="col-lg-3 mb-4 " style="text-align: center;">
                            ...
                            <a class="blog-overlay text-decoration-none" style="justify-content: center;" href="thongtingiaovien.php?id_giaovien=<?php echo $row_k["id_giaovien"]; ?>">
