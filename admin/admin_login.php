<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $login_query="SELECT * FROM `admin` WHERE username='$username' and password='$password' AND trangthai_dn='1'";
            ...
            <div class="row">
						...
						<div class="module container" style="width:70%; ">
							<div class="module-head"style=";background-color: #aa135e;" >
								<h1 style="text-align:center;color:#fff;">ĐĂNG NHẬP QUẢN LÝ</h1>
							</div>
