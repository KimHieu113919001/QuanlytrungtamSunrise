            ...
            <br>
              ...
              <?php 
                while($row_tb=mysqli_fetch_assoc($res_tb)){ ?>
                    <div><i class="fas fa-angle-double-right"></i>&ensp;<a style="font-size: 20px; color:blue;" href="user_thongbao.php?id_thongbao=<?php echo $row_tb['id_thongbao']?>"><?php echo $row_tb['tieude']?></a></div>
                <?php } 
