<?php
    ...
    include("config.php");
     ...
     $sql = "SELECT * FROM chi_tiet_hoc, hocvien, diemso WHERE chi_tiet_hoc.id_hocvien=diemso.id_hocvien AND diemso.id_danhsach='$_GET[id_danhsach]' AND chi_tiet_hoc.id_hocvien=hocvien.id_hocvien AND chi_tiet_hoc.id_danhsach='$_GET[id_danhsach]'";
