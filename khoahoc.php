        ...
        <div class="container-fluid page-header" style="margin-bottom: 40px;">
            <div class="container">
                <div class="d-flex flex-column justify-content-center" style="min-height: 250px">
                    <h3 class="display-4 text-white text-uppercase">Các cấp độ</h3>
                    <div class="d-inline-flex text-white">
                        <p class="m-0 text-uppercase"><a class="text-white" href="user.php">Trang chủ</a></p>
                        <i class="fa fa-angle-double-right pt-1 px-3"></i>
                        <p class="m-0 text-uppercase">Các cấp độ</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">  
            <div class="row pb-3">
                    ...
                    <div class="col-lg-4 mb-4" style="text-align: center;">
                            ...
                            <span>
                                <img  class="img-fluid" src="admin/images/<?php echo $row["hinhanh"]; ?>"  alt="">
                            </span>
            ...
            <?php
				...
				<ul class="list_trang">
					...
					for($i=1;$i<=$trang;$i++){ 
					?>
						<li <?php if($i==$page){echo 'style="background: brown;"';}else{ echo ''; }  ?>><a href="khoahoc.php?trang=<?php echo $i ?>"><?php echo $i ?></a></li>
					<?php
					} 
					?>
				</ul>     
