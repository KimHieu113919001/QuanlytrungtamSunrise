...
<body class="colormix">
  ...
  <div class="container-fluid"> 
      ...
      <div class="bg-secondary rounded p-5">
          ...
          <?php echo $msg;?>
          <div class="hinh">
              <h1 style="text-align: center; background-color:#F2F1F8; color:#000000;">Thêm điểm</h1>      
          </div>
          <br>
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                  <input type="text" class="form-control" readonly value="<?php echo ucwords($row1['ma_danhsach']);?>" >
              </div> 
          <br>
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
              ...
              <div class="input-group">
                  ...
                  <input type="number" class="form-control" name="diemtong" placeholder="Nhập điểm tổng kết" required>
              </div>
                 <br>
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                  <textarea type="text" class="form-control" name="nhanxet" placeholder="Nhập nhận xét"></textarea>
              </div>
              <br>
