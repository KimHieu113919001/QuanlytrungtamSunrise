<?php 
    ...
    if(!isset($_SESSION['id_giaovien'])){
     ...
     if(isset($_POST['lichtructuan'])){
      $id_tuan=$_POST['id_tuan'];
      header('Location: lichtructuan2.php?id_tuan='.$id_tuan);
    }
     ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="container-fluid"> 
  <div class="container">
        ...
        <label class="control-label" for="basicinput">Xem lịch trực</label>
        ...
        <select class="form-control namhoc" id="id_namhoc" name="id_namhoc" onchange="myFunction()" >
            ...
            <select class="form-control tuan" id="id_tuan" name="id_tuan" onchange="myFunction()" required>
                  ...
                  <div style="text-align:center;">
                    <button type="submit" class="btn btn-success" name="lichtructuan">Chọn</button>
                  </div>
<br>
            </form>
            <br>
...
<!-- JavaScript Libraries -->
  ...
  <script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
    ...
    <!-- <script>
        ...
        $(".lichtruc").change(function(){
        var id_tuan = $(".lichtruc").val();
        $.post("lichtructuan2.php",{id_tuan:id_tuan}, function(data){
            $(".test").html(data);
        })
    })
})
