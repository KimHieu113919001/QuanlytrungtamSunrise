<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $login_query="SELECT * FROM `hocvien` WHERE username='$username' AND password='$password'";
        ...
        if(mysqli_num_rows($login_res)>0){ 
            ...
            $_SESSION['id_hocvien']=$row['id_hocvien'];
  ...
  <div class="container-fluid"> 
      ...
      <div class="bg-secondary rounded p-5">
          ...
          <div class="hinh">
              ...
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                <a href="log_and_sign/login_gv.php" class="btn btn-danger py-md-2 px-md-4 font-weight-semi-bold mt-2" style="width:100%">Đăng nhập nhân viên</a>
              </div>   
            </form>
      </div> 
    </div>
