    ...
    <div class="container-fluid page-header" style="margin-bottom: 10px;">
        <div class="container">
            <div class="d-flex flex-column justify-content-center" style="min-height: 270px">
                <h3 class="display-4 text-white text-uppercase" style="text-align:center;">Thông tin cấp độ</h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mt-5 ">
                    ...
                    <div class="mb-5">
                        ...
                        <a class="d-flex align-items-center text-decoration-none mb-3" href="thongtinkhoahoc.php?id_khoahoc=<?php echo $row2['id_khoahoc'];?>">
                            <img style="width:80px;height:80px;"  class="img-fluid rounded" src="../sunrise/admin/images/<?php echo $row2['hinhanh'];?>" alt="">
                            <div class="pl-3">
                    ...
                    <div class="mb-5">
                    <a href="dangkyhoc.php" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Đăng ký ngay</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid py-2 ">
    ...
    <h4 class="mb-4" style="color:#000; text-align:center;">Một số hình ảnh khác</h4>
