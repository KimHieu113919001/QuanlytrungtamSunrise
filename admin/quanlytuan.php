...
<div class="span9">
					<div class="content">
						<div class="module">
							...
							<a class="btn btn-success" href="themnam.php">Thêm năm học mới</a> &ensp;
							</div>
									...
									?>
										<tr class="odd gradeX">
                                            ...
                                            <?php if($row['trangthai'] == 0){ ?>
                                                <a class="btn btn-success" href="themtuan.php?id_namhoc=<?php echo $row["id_namhoc"]; ?>">Thêm tuần</a> &ensp;
                      						<?php }else{ ?>
                                                <a class="btn btn-success disabled" href="themtuan.php?id_namhoc=<?php echo $row["id_namhoc"]; ?>">Đã thêm tuần</a> &ensp;
                                            <?php } ?>
                                            <a class="btn btn-warning " href="suatuan.php?id_namhoc=<?php echo $row["id_namhoc"]; ?>">Sửa</a></td>
